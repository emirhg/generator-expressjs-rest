...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    // CRUD routes
    this.fs.copyTpl(
      this.templatePath('src/API/Routes/endpoint.routes.ts'),
      this.destinationPath(`src/API/Routes/${this.options.models}/${this.options.modelsInstance}.routes.ts`),
      {props : this.props, options : this.options}
    );

    // Controller base file
    this.fs.copyTpl(
      this.templatePath('src/API/Controllers/Controller.ts'),
      this.destinationPath(`src/API/Controllers/${this.options.model}Controller.ts`),
      {props : this.props, options : this.options}
    );
